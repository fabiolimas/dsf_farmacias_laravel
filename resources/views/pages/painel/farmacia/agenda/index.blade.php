                    ...
                    <div class="card-body py-3 px-0 px-md-2 px-lg-2  py-lg-4">
                        ...
                        <div class="px-3 d-flex justify-content-between align-items-center mb-4 pt-2">
                            ...
                            <div class="">
                                ...
                                <a href="{{ route('painel.farmacia.exames.create') }}" data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        <div class="position-relative mt-4">
                            ...
                            <div class=" lista-scroll p-3 pt-0 clientes-lista-assinantes " style="max-height: 550px">
                                ...
                                @foreach ($examesDia as $agenda)
                                    ...
                                    <!-- Modal ver agenda -->
    <div class="modal modal-custom fade" id="modal-ver-agenda-{{$agenda->id}}" tabindex="-1" data-bs-backdrop="static"
                    ...
                    <div class="d-flex flex-column flex-lg-row flex-wrap gap-4">
                        ...
                        <div class="">
                            <div class="d-flex align-items-center p-3 rounded-3 px-4"
                                ...
                                <div class=" fs-20px ms-3">
                                    <a href="#" class="text-decoration-none d-block">
                                        <div class="text-green-2 fw-500 text-truncate">Exame: {{$agenda->nome_exame}}
                                        </div>
                        ...
                        <div class="">
                            <div class="d-flex flex-column flex-lg-row align-items-center p-3 px-4 rounded-3 gap-2 gap-lg-4"
                                ...
                                <div class="d-flex align-items-center w-lg-100">
                                    ...
                                    <div class=" fs-20px ms-3">
                                        <a href="#" class="text-decoration-none d-block">
                                            <div class="text-green-2 fw-500 text-truncate">Cliente: {{$agenda->nome_cliente}}
                                            </div>
                                            <div class="text-green text-truncate">CPF: {{$agenda->cpf}}</div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center w-lg-100">
                                    ...
                                    <div class=" fs-20px ">
                                        <a href="#" class="text-decoration-none d-block">
                                            <div class="text-green-2 fw-500 text-truncate">Número: {{$agenda->telefone}}
                                            </div>
                                            <div class="text-green text-truncate text-truncate">Email: {{$agenda->email}}</div>
                                        </a>
                                    </div>
                                </div>
