                                    ...
                                    <div class="col-md-3">
                                       ...
                                       @foreach($pergunta['opcoes'] as $opcao)
                                          <label for="{{$opcao}}">{{$opcao}}</label>
                                            <input type="checkbox" id="{{$opcao}}" name="respostas[]" value="{{$opcao}}" class="form-check-input">
                                       ...
                                       @case('resposta-curta')
                                       {{ $pergunta['pergunta'] }}
                                       <input type="hidden" class="form-control" name="perguntas[]" value="{{ $pergunta['pergunta'] }}">
