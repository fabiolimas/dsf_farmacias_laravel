                    ...
                    <div class="card-body py-3 px-0 px-md-2 px-lg-2  py-lg-4">
                        ...
                        <div class=" px-3">
                            <a class="btn btn-primary d-block d-md-inline-block mb-3 me-lg-3   "
                                href="{{ route('painel.farmacia.exames.atendimento') }}" role="button"
                                ...
                                @foreach ([3, 33, 3, 3, 3] as $item)
                                    ...
                                    <div class="px-0 pb-4">
                                        ...
                                        <div
                                            ...
                                            <a href="#" class="px-2 py-2  text-decoration-none d-block text-start "
                                            ...
                                            <a href="{{ route('painel.farmacia.exames.atendimento') }}"
                        ...
                        <div class=" ">
                            <div class="">
                                ...
                                <div class="d-flex  flex-column flex-lg-row gap-2 align-items-center ">
                                    <h2 class="fs-4 fw-600 mb-4 text-green-2 px-0 ps-lg-4 text-center text-md-start   " style="min-width: 260px">
                                        Exames realizados
                                    </h2>
                                    ...
                                    <div class="d-flex align-items-center w-lg-100">
                                        ...
                                        <div class=" fs-20px ">
                                            <a href="#" class="text-decoration-none d-block">
                                                ...
                                                <div class="text-green text-truncate text-truncate">Email:
                                                    pedrohenrique@gmail.com</div>
                                            </a>
                                        </div>
                                    </div>
