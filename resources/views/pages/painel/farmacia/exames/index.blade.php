                    ...
                    <div class="card-body py-3 px-0 px-md-2 px-lg-2  py-lg-4">
                        ...
                        <div class=" px-3">
                            <a class="btn btn-primary d-block d-md-inline-block mb-3 me-lg-3   "
                                href="{{ route('painel.farmacia.exames.confirmados') }}" role="button"
                                        ...
                                        <div class="px-0 pb-4">
                                            ...
                                            <div
                                                ...
                                                <a href="#"
                                                    ...
                                                    data-bs-target="#modal-ver-agenda-{{ $agenda->agendaId}}">
                                                ...
                                                <a href="#"
                                                    ...
                                                    data-bs-target="#modal-presenca-{{ $agenda->agendaId }}">
                                                    Confirmar
                                                </a>
                                            </div>
                                                            ...
                                                            <div class="row mt-4 pt-2 gy-3">
                                                                ...
                                                                <div class="col-12 col-lg-6">
                                                                    <button type="button"
                                                                        ...
                                                                        data-bs-target="#modal-presenca-{{ $agenda->agendaId }}">Confirmar Presença</button>
                                                                </div>
                                                            </div>
