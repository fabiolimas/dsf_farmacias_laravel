                ...
                <div class="card min-vh-100">
                    <div class="card-body px-2 py-4 ">
                        ...
                        <div class="border-green-light p-3 rounded-3 mb-4 ">
                            ...
                            <form action="{{ route('painel.farmacia.exames.update-dados-exame', $resultado->id) }}" method="post">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3 mt-3">
                                        ...
                                        <input type="text" class="form-control" name='responsavel'
                                            value="{{ $cliente->responsavel }}" id="responsavel" >
                                    </div>
                        ...
                        <div class="border-green-light p-3 rounded-3 mb-4 ">
                            ...
                            <div class="row">
                                <div class="col-md-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" name='peso' value="{{$resultado->peso}}"
                                        id="peso">
                                </div>
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <select class="form-select" name="gestante" id="gestante">
                                        <option value="{{$resultado->gestante}}" selected>{{$resultado->gestante}}</option>
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <select class="form-select" name="fumante" id="fumante">
                                        <option value="{{$resultado->fumante}}" selected>{{$resultado->fumante}}</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <select class="form-select" name="usa_insulina" id="usa_insulina">
                                        <option value="{{$resultado->usa_insulina}}" selected>{{$resultado->usa_insulina}}</option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" name='uso_de_medicamentos' value="{{$resultado->uso_de_medicamentos}}"
                            ...
                            <div class="row mt-3">
                                <div class="col-md-3 mt-3">
                                    ...
                                    <input type="text" class="form-control " name="medico_responsavel"
                                        id="medico_responsavel" value="{{$resultado->medico_responsavel}}">
                                </div>
                                <div class="col-md-3 mt-3">
                                    <label for="crm">CRM</label>

                                    <input type="text" class="form-control " name="crm" id="crm" value="{{$resultado->crm}}">
                                </div>
                                <div class="col-md-3 mt-3">
                                    <label for="endereco_medico">Endereço</label>

                                    <input type="text" class="form-control " name="endereco_medico"
                                        id="endereco_medico" value="{{$resultado->endereco_medico}}">
                                </div>
                                <div class="col-md-3 mt-3">
                                    <label for="telefone_medico">Telefone</label>

                                    <input type="text" class="form-control " name="telefone_medico"
                                        id="telefone_medico" value="{{$resultado->telefone_medico}}">
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="col-md-4 mt-3">
                            ...
                            <input type="text" class="form-control " name="responsavel_atendimento"
                                id="responsavel_atendimento" value="{{ $resultado->responsavel_atendimento }}">
                        </div>
