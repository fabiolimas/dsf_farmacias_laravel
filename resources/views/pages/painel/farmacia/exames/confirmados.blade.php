                    ...
                    <div class="card-body px-2 py-4">
                        ...
                        <div class=" ">
                            <div class="">
                                ...
                                href="{{ route('painel.farmacia.exames.lista') }}" role="button"
                                ...
                                <div class="mt-4 px-2 px-md-0">
                                    <div class="px-lg-4">
                                        @foreach ($examesConfirmados as $confirmado)
                                                    ...
                                                    <div class="d-flex gap-3 align-items-center">
                                                        <div class="">
                                                            <div
                                                                ...
                                                                <div class="fs-24px text-green-2 mb-1 px-2">{{date('d',strtotime($confirmado->data_exame))}}</div>
                                                                <div class="fs-16px text-green px-2 fw-500">{{date('M', strtotime($confirmado->data_exame))}}</div>
                                                            </div>
                                                        </div>

                                                        <div class="fs-20px fw-500 ">
                                                            <a href="{{route('painel.farmacia.exames.dados-exame', $confirmado->id)}}"
                                                                class="text-decoration-none d-block">
                                                                <div class="text-green-2">{{$confirmado->nome_exame}}</div>
                                                                <div class="text-green">{{$confirmado->nome_cliente}}</div>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <!-- img -->
