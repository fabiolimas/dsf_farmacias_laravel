...
@section('content')
                    ...
                    <div class="card-body px-2 py-4">
                        ...
                        <div class=" px-1 px-md-4">
                            ...
                            <a name="" id="" class="btn btn-outline-primary d-block d-md-inline-block mb-3 "
                                href="{{ route('painel.admin.clientes.list') }}" role="button" style="padding: 16px 24px;">
                                <div class="d-flex gap-2 align-items-center">
                        ...
                        <div class="mt-2 pt-1 ">
                            <div class="">
                                ...
                                <div class="mt-4 pt-2">
                                    ...
                                    {{-- <div id="load-pesquisa" class="d-flex">
                    ...
                    <div class="card-body px-2 py-4">
                        <div class="px-1">
                            ...
                            <div class="px-2 px-lg-3 mb-1 text-end">
                                <a class="btn btn-primary d-block d-md-inline-block mb-3   "
                                    href="{{ route('painel.admin.clientes.pagamento.index') }}" role="button"
    ...
    <div
                                            ...
                                            <div class="">
                                                <img src="{{ asset('assets/img/ilustracoes/logo-fm-pg-menos.png') }}"
                                ...
                                <div class="d-flex align-items-center p-3 rounded-3 px-2 px-md-4"
                                    ...
                                    <div class="">
                                        <div class="bg-white position-relative bg-logo-farmacia" id="bg-logo-farmacia"
                                            style="background-image: url({{ asset('assets/img/ilustracoes/logo-fm.png') }}); border: 1px solid #00B1AC">
                                        </div>
                                    </div>
                                    <!-- nome -->
...
@section('scripts')
    ...
    <script>
                        ...
                        <div class="d-flex mb-3 pt-1 align-items-center">
                            ...
                            <div class="ms-auto" onclick="setDataCliente('${res.data[i].id}')"
                                ...
                                <a class="text-decoration-none" data-bs-toggle="tooltip"
                                    ...
                                    <img src="` + "{{ asset('assets/img/icons/dots.svg') }}" + `"
                                        alt="">
                                </a>
        ...
        function pesquisAssinaturas() {
            ...
            axios
                .get(`{{ route('painel.admin.clientes.pagamento.ultimas-assinaturas') }}?nome=${str}`)
                .then(res => {
                    console.log(res.data)
