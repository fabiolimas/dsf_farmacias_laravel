...
@section('content')
    <div class="">
        <form action="{{ route('painel.config.cargos.update', $cargo->id) }}" method="post">
            @csrf
            @method('PUT')
            <div class="row gy-4">
                        ...
                        <div class="card-body p-3 p-lg-4">
                            ...
                            <div class="mb-3 pb-2">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('titulo', $cargo->name) }}" required />
                                @error('titulo')
                            ...
                            <div class="d-flex gap-2 flex-wrap" id="colaboradores-adicionados">
                                @foreach ($colaboradores as $colaborador)
                                    <div
                                        ...
                                        <div class="">
                                            <img src="{{asset($colaborador->img_perfil)}}" alt="" class="border-green-light rounded-circle"
                                ...
                                <div class="ms-auto">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="permissoes[0]"
                                            ...
                                            @if (old('permissoes.0', in_array('agenda', $nomePermissoes))) checked @endif>
                                    </div>
                                </div>
                            </div>
                            <!--  -->
                                ...
                                <div class="ms-auto">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="permissoes[1]"
                                            ...
                                            @if (old('permissoes.1', in_array('clientes', $nomePermissoes))) checked @endif>
                                    </div>
                                </div>
                            </div>
                            <!--  -->
                                ...
                                <div class="ms-auto">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="permissoes[2]"
                                            ...
                                            @if (old('permissoes.2', in_array('exames', $nomePermissoes))) checked @endif>
                                    </div>
                                </div>
                            </div>
                            <!--  -->
                                ...
                                <div class="ms-auto">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            ...
                                            @if (old('permissoes.3', in_array('graficos', $nomePermissoes))) checked @endif>
                                    </div>
                                </div>
                            </div>
                            <!--  -->
                                ...
                                <div class="ms-auto">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            ...
                                            @if (old('permissoes.4', in_array('ajustes', $nomePermissoes))) checked @endif id="flexSwitchCheckDefault">
                                    </div>
                                </div>
                            </div>
