                                    ...
                                    <div class="">
                                        <div class="">
                                            <a class="btn btn-light bg-white shadow-sm border text-green fw-600 text-green "
                                                href="{{ route('painel.farmacia.graficos.index') }}">
                                                Ver mais
                                            </a>
                                    ...
                                    <div class="mt-2 lista-scroll p-3 clientes-lista-assinantes resultBusca">
                                        ...
                                        @foreach ($clientes as $cliente)
                                            <div class="d-flex gap-2 justify-content-between mb-3 fs-18px text-green-2 fw-600">
                                                <div class="">
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-ver-cliente-{{$cliente->id}}"
                                            ...
                                            <div class="modal  modal-custom fade" id="modal-ver-cliente-{{$cliente->id}}" tabindex="-1"
                                                                            ...
                                                                            <div class=" fs-20px ms-3">
                                                                                <a href="#"
                                                                                    ...
                                                                                    <div class="text-green-2 fw-500 text-truncate">
                                                                                        {{$cliente->nome}}</div>
                                                                                    <div class="text-green">{{$cliente->sexo}}, {{ date('Y', strtotime('now')) - date('Y', strtotime($cliente->data_nascimento)) }} anos
                                                                                    </div>
                                                                                </a>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center p-3 rounded-3 px-4 w-100"
                                                                            ...
                                                                            <div class=" fs-20px">
                                                                                <a href="#"
                                                                                    ...
                                                                                    <div class="text-green-2 fw-500 text-truncate">
                                                                                        CPF</div>
                                                                                    <div class="text-green">{{$cliente->cpf}}</div>
                                                                                </a>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center p-3 rounded-3 px-4 w-100"
                                                                            ...
                                                                            <div class=" fs-20px">
                                                                                <a href="#"
                                                                                    ...
                                                                                    <div class="text-green-2 fw-500 text-truncate">
                                                                                        Telefone</div>
                                                                                    <div class="text-green">{{$cliente->telefone}}</div>
                                                                                </a>
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center p-3 rounded-3 px-4 w-100"
                                                                            ...
                                                                            <div class=" fs-20px">
                                                                                <a href="#"
                                                                                    ...
                                                                                    <div class="text-green-2 fw-500 text-truncate">
                                                                                        Email</div>
                                                                                    <div class="text-green">{{$cliente->email}}
                                                                                    </div>
                                                                                </a>
                                                                            </div>
                                                    ...
                                                    <div class="">
                                                        <div
                                                            ...
                                                            <div class="fs-24px text-green-2 mb-1 px-2">
                                                                {{ date('d', strtotime($exame->data_exame)) }}</div>
                                                            <div class="fs-16px text-green px-2">
                                                                {{ date('M', strtotime($exame->data_exame)) }}</div>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex  align-items-center">
                                                        <div class="">
                                                            <div class="text-green-2 fs-18px">{{ $exame->nome_exame }}</div>
                                                            <div class="text-green fs-16px">{{ $exame->nome_cliente }}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <a href="{{ route('painel.farmacia.exames.show', ['id' => $exame->id]) }}"
                            ...
                            <div class="card-body px-0 px-md-2 py-4">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="mt-2 lista-scroll p-3 px-2 clientes-lista-assinantes ">
                                        ...
                                        <!--  -->
                                        @foreach ($examesPendentes as $exameP)
                                            <a href="#"
                                                class="px-2 py-2 proximo-horarios mb-3 rounded-3 text-decoration-none d-block"
                                                data-bs-toggle="modal" data-bs-target="#modal-ver-agenda-{{ $exameP->agendaId }}">
                                                <div class="d-flex gap-4 align-items-center ">
                                                    ...
                                                    <div class="fs-18px text-green-2 fw-600">
                                                        <div class="">{{ $exameP->nome_exame }}</div>
                                            ...
                                            @can('farmacia')
                                                <!-- Modal ver agenda -->
                                                <div class="modal modal-custom fade" id="modal-ver-agenda-{{ $exameP->agendaId }}"
                                                            ...
                                                            <div class="modal-body p-lg-5  border-0">
                                                                ...
                                                                <div class="p-4 shadow rounded-3  bg-white border">
                                                                            ...
                                                                            <div class="d-flex align-items-center p-3 rounded-3 px-4"
                                                                                ...
                                                                                <div class=" fs-20px ms-3">
                                                                                    <a href="#"
                                                                                        ...
                                                                                        {{-- <div
                                                                                            class="text-green-2 text-truncate fw-600">
                                                                                            às 09:00</div> --}}
                                                                                    </a>
                                                                                </div>
                                                                                ...
                                                                                <div class=" fs-20px ms-3">
                                                                                    <a href="#"
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            Responsável: </div>
                                                                                        <div class="text-green">{{$exameP->name}}</div>
                                                                                    </a>
                                                                                </div>
                                                                            ...
                                                                            <div class="d-flex align-items-center p-3 rounded-3 px-4"
                                                                                ...
                                                                                <div class=" fs-20px ms-3">
                                                                                    <a href="#"
                                                                                        ...
                                                                                        <div
                                                                                            class="text-green-2 fw-500 text-truncate">
                                                                                            Exame: {{$exameP->nome_exame}}
                                                                                        </div>
                                                                                        <div class="text-green text-truncate">{{$exameP->estoque}} em
                                                                                            estoque</div>
                                                                                    </a>
                                                                                </div>
                                                                                ...
                                                                                <div class="d-flex align-items-center ">
                                                                                    ...
                                                                                    <div class=" fs-20px ">
                                                                                        <a href="#"
                                                                                            ...
                                                                                            <div
                                                                                                class="text-green-2 fw-500 text-truncate">
                                                                                                Número: {{$exameP->telefone}}
                                                                                            </div>
                                                                                            <div class="text-green text-truncate">
                                                                                                Email: {{$exameP->email}}</div>
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="row mt-4 pt-2">
                                                                        <div class="col-12 col-lg-6">
                                                                            <a href="{{ route('painel.farmacia.agenda.edit', $exameP->agendaId) }}"
                                                                        ...
                                                                        <div class="col-12 col-lg-6">
                                                                            <button type="button"
                                                                                ...
                                                                                data-bs-target="#modal-presenca-{{ $exameP->agendaId }}">Confirmar</button>
                                                                        </div>
                                                                    </div>
                            ...
                            <div class="card-body px-2 py-4">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="mt-2 lista-scroll p-3 clientes-lista-assinantes " style="max-height: 320px">
                                        ...
                                        @foreach ($examesAcabando as $exameFim)
                                            <div
                                                ...
                                                <div class="d-flex  align-items-center">
                                                    <div class="text-green-2 fs-20px">{{$exameFim->nome}}</div>
                                                </div>
                                                <div class="ms-auto">
                                                    <div
                                                        class="bg-white border-green-light px-1 py-1  text-center lh-1 rounded-3">
                                                        <div class="fs-16px text-green px-1 fs-20px">{{$exameFim->estoque}}</div>
                                                    </div>
                                                </div>
