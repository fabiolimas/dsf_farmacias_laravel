                    ...
                    <div class="card-body py-3 px-2 px-lg-2  py-lg-4">
                        ...
                        <div class="px-3 d-flex justify-content-between align-items-center mb-4 pt-2">
                            ...
                            <div class="">
                                ...
                                <a href="<?php echo e(route('painel.exames.create')); ?>" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <div class="card-body py-3 px-2 px-lg-2  py-lg-4">
                        ...
                        <div class="px-3 d-sm-flex text-center text-sm-start justify-content-between align-items-center mb-4 pt-2">
                            ...
                            <div class="">
                                ...
                                <a href="<?php echo e(route('painel.agenda.create')); ?>"
...
<?php echo $__env->make('layouts.painel.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u292571460/domains/indutivatecnologia.com/public_html/dsf/resources/views/pages/painel/agenda/index.blade.php ENDPATH**/ ?>