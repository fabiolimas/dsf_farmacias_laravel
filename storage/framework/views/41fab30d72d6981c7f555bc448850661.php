<div class="position-relative mt-4 resultPesquisa">
    ...
    <div class=" lista-scroll p-3 pt-0 clientes-lista-assinantes " style="max-height: 550px">
        ...
        <?php $__currentLoopData = $examesDia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <!-- Modal ver agenda -->
            <div class="modal modal-custom fade" id="modal-ver-agenda-<?php echo e($agenda->id); ?>"
    ...
    <?php else: ?>
    <?php endif; ?>
</div><?php /**PATH C:\xampp\htdocs\indutiva\dsf_farmacias_laravel\resources\views/pages/painel/farmacia/buscas/exames_agendados.blade.php ENDPATH**/ ?>