                    ...
                    <div class="card-body px-2 py-4">
                        ...
                        <div class=" px-4">
                            <a class="btn btn-primary d-block d-md-inline-block mb-3   "
                                href="<?php echo e(route('painel.admin.exames.create')); ?>" role="button" style="padding: 16px 24px;">
                                                        ...
                                                        <div class="d-flex gap-3 align-items-center">
                                                            ...
                                                            <div class="fs-20px fw-500 ">
                                                                <a href="<?php echo e(route('painel.admin.exames.edit', $exame->id)); ?>"
                                                                    ...
                                                                    <div class="text-green-2"><?php echo e($exame->nome); ?></div>
                                                        ...
                                                        <div class=" d-sm-flex gap-3 mt-2 mt-xl-0">
                                                            ...
                                                            <div class="mt-2 mt-sm-0">
                                                                <div class="" data-bs-toggle="modal"
                                                                    onclick="setRotaRemover(`<?php echo e(route('painel.admin.exames.destroy', $exame->id)); ?>`)"
        ...
        <div class="modal-content bg-transparent ">
            <div class="modal-body p-lg-5  border-0">
                ...
                <div class="p-4 shadow rounded-3  bg-white border">
                    ...
                    <form action="<?php echo e(route('painel.admin.exames.destroy', $exame->id)); ?>" method="post" id="form-remover">
...
<?php echo $__env->make('layouts.painel.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\indutiva\dsf_farmacias_laravel\resources\views/pages/painel/admin/exames/index.blade.php ENDPATH**/ ?>