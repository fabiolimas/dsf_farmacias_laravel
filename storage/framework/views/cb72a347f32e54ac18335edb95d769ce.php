                                ...
                                <?php $__currentLoopData = $examesDia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="px-2 pb-4">
                                        ...
                                        <a href="#"
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#modal-ver-agenda-<?php echo e($agenda->id); ?>">
                                    ...
                                    <!-- Modal ver agenda -->
    <div class="modal modal-custom fade" id="modal-ver-agenda-<?php echo e($agenda->id); ?>" tabindex="-1" data-bs-backdrop="static"
                    ...
                    <div class="d-flex flex-column flex-lg-row flex-wrap gap-4">
                        ...
                        <div class="">
                            <div class="d-flex align-items-center p-3 rounded-3 px-4"
                                ...
                                <div class=" fs-20px ms-3">
                                    <a href="#" class="text-decoration-none d-block">
                                        <div class="text-green-2 fw-500 text-truncate">Exame: <?php echo e($agenda->nome_exame); ?>
                        ...
                        <div class="">
                            <div class="d-flex flex-column flex-lg-row align-items-center p-3 px-4 rounded-3 gap-2 gap-lg-4"
                                ...
                                <div class="d-flex align-items-center w-lg-100">
                                    ...
                                    <div class=" fs-20px ms-3">
                                        <a href="#" class="text-decoration-none d-block">
                                            <div class="text-green-2 fw-500 text-truncate">Cliente: <?php echo e($agenda->nome_cliente); ?>

                                            </div>
                                            <div class="text-green text-truncate">CPF: <?php echo e($agenda->cpf); ?></div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center w-lg-100">
                                    ...
                                    <div class=" fs-20px ">
                                        <a href="#" class="text-decoration-none d-block">
                                            <div class="text-green-2 fw-500 text-truncate">Número: <?php echo e($agenda->telefone); ?>

                                            </div>
                                            <div class="text-green text-truncate text-truncate">Email: <?php echo e($agenda->email); ?></div>
                                        </a>
                                    </div>
                                </div>
