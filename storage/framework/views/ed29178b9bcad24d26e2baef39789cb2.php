                ...
                <div class="card min-vh-100">
                    <div class="card-body px-2 py-4 ">
                        ...
                        <div class="border-green-light p-3 rounded-3 mb-4 ">
                            ...
                            <form action="<?php echo e(route('painel.farmacia.exames.update-dados-exame', $resultado->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                        ...
                        <div class="border-green-light p-3 rounded-3 mb-4 ">
                            ...
                            <div class="row">
                                <div class="col-md-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" name='peso' value="<?php echo e($resultado->peso); ?>"
                                        id="peso">
                                </div>
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <select class="form-select" name="gestante" id="gestante">
                                        <option value="<?php echo e($resultado->gestante); ?>" selected><?php echo e($resultado->gestante); ?></option>
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <select class="form-select" name="fumante" id="fumante">
                                        <option value="<?php echo e($resultado->fumante); ?>" selected><?php echo e($resultado->fumante); ?></option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <select class="form-select" name="usa_insulina" id="usa_insulina">
                                        <option value="<?php echo e($resultado->usa_insulina); ?>" selected><?php echo e($resultado->usa_insulina); ?></option>
                                        <option value="Sim">Sim</option>
                                        <option value="Não">Não</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" name='uso_de_medicamentos' value="<?php echo e($resultado->uso_de_medicamentos); ?>"
                            ...
                            <div class="row mt-3">
                                <div class="col-md-3 mt-3">
                                    ...
                                    <input type="text" class="form-control " name="medico_responsavel"
                                        id="medico_responsavel" value="<?php echo e($resultado->medico_responsavel); ?>">
                                </div>
                                <div class="col-md-3 mt-3">
                                    <label for="crm">CRM</label>

                                    <input type="text" class="form-control " name="crm" id="crm" value="<?php echo e($resultado->crm); ?>">
                                </div>
                                <div class="col-md-3 mt-3">
                                    <label for="endereco_medico">Endereço</label>

                                    <input type="text" class="form-control " name="endereco_medico"
                                        id="endereco_medico" value="<?php echo e($resultado->endereco_medico); ?>">
                                </div>
                                <div class="col-md-3 mt-3">
                                    <label for="telefone_medico">Telefone</label>

                                    <input type="text" class="form-control " name="telefone_medico"
                                        id="telefone_medico" value="<?php echo e($resultado->telefone_medico); ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 mt-3">
                                    ...
                                    <textarea class="form-control" name="observacao" id="observacao">
                                        <?php echo e($resultado->observacoes); ?>"
                                    </textarea>
                                </div>
                        ...
                        <div class="col-md-4 mt-3">
                            ...
                            <input type="text" class="form-control " name="responsavel_atendimento"
                                id="responsavel_atendimento" value="<?php echo e($resultado->responsavel_atendimento); ?>">
                        </div>
...
<?php echo $__env->make('layouts.painel.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\indutiva\dsf_farmacias_laravel\resources\views/pages/painel/farmacia/exames/edit-dados-exame.blade.php ENDPATH**/ ?>