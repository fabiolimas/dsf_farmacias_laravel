...
<?php $__env->startSection('content'); ?>
                                    ...
                                    <div class="mt-2 lista-scroll p-3 clientes-lista-assinantes ">
                                        ...
                                        <?php $__currentLoopData = [3, 3, 3, 3, 3, 3, 3]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="d-flex gap-2 justify-content-between mb-3 fs-18px text-green-2 fw-600">
                                                <div class="">
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-ver-cliente"
                                                        class="text-green-2 text-decoration-none">
                                                        Antônio Lima
                                                    </a>
                                                </div>
                                                <div class="">(98) 93176-6784</div>
                                            </div>
                                                ...
                                                <div class="d-flex gap-2 mb-2 mb-sm-0">
                                                    <div class="">
                                                        <div
                                                            ...
                                                            <div class="fs-16px text-green px-2">Ago</div>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex  align-items-center">
                                                        <div class="">
                                                            <div class="text-green-2 fs-18px">PSA Teste Rápido</div>
                                                            <div class="text-green fs-16px">Carla Silva</div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="mt-2 lista-scroll p-3 px-2 clientes-lista-assinantes ">
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="d-flex gap-4  align-items-center">
                                                ...
                                                <div class="divisor-horarios cor-verde"></div>
                                                <div class="fs-18px text-green-2 fw-600">
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="d-flex gap-4  align-items-center">
                                                ...
                                                <div class="divisor-horarios cor-laranja"></div>
                                                <div class="fs-18px text-green-2 fw-600">
                                                    <div class="">Dengue Antígeno NS1</div>
                                                    <div class="text-green">
                                                        Pedro Henrique
                                                    </div>
                                                </div>
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="d-flex gap-4  align-items-center">
                                                ...
                                                <div class="divisor-horarios cor-vermelho"></div>
                                                <div class="fs-18px text-green-2 fw-600">
                                                    <div class="">Ácido Úrico</div>
                                                    <div class="text-green">
                                                        Pedro Henrique
                                                    </div>
                                                </div>
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="d-flex gap-4  align-items-center">
                                                ...
                                                <div class="divisor-horarios cor-azul"></div>
                                                <div class="fs-18px text-green-2 fw-600">
                                    ...
                                    <div class="mt-2 lista-scroll p-3 clientes-lista-assinantes " style="max-height: 320px">
                                        ...
                                        <?php $__currentLoopData = [3, 3, 3, 3, 3, 3, 3]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div
                                                ...
                                                <div class="d-flex  align-items-center">
                                                    <div class="text-green-2 fs-20px">Corona vírus</div>
                                                </div>
                                                <div class="ms-auto">
                                                    <div
                                                        class="bg-white border-green-light px-1 py-1  text-center lh-1 rounded-3">
                                                        <div class="fs-16px text-green px-1 fs-20px">4</div>
                                                    </div>
                                                </div>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('farmacia')): ?>
        ...
        <!-- modal ver cliente -->
        <div class="modal  modal-custom fade" id="modal-ver-cliente" tabindex="-1" data-bs-keyboard="false" role="dialog"
                        ...
                        <div class=" p-4 shadow rounded-3  bg-white border">
                                ...
                                <div class="d-flex align-items-center p-3 rounded-3 px-4 w-100"
                                    ...
                                    <div class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            ...
                                            <path
                                                d="M33 65C50.6731 65 65 50.6731 65 33C65 15.3269 50.6731 1 33 1C15.3269 1 1 15.3269 1 33C1 50.6731 15.3269 65 33 65Z"
                                                stroke="#00B1AC" stroke-linecap="round" stroke-linejoin="round" />
                                            <defs>
                                                ...
                                                <image id="image0_81_1486" width="1209" height="805"
                                    ...
                                    <div class=" fs-20px ms-3">
                                        <a href="#" class="text-decoration-none d-block">
                                            <div class="text-green-2 fw-500 text-truncate">Fábio Vieira</div>
                                            <div class="text-green">Masculino, 28 anos</div>
                                        </a>
                                    </div>
                            ...
                            <div class="mb-3">
                                <div class="d-flex align-items-center p-3 rounded-3 px-4 w-100"
                                    ...
                                    <div class=" fs-20px">
                                        <a href="#" class="text-decoration-none d-block">
                                            <div class="text-green-2 fw-500 text-truncate">CPF</div>
                                            <div class="text-green">123.456.789-10</div>
                                        </a>
                                    </div>
                            ...
                            <div class="mb-3">
                                <div class="d-flex align-items-center p-3 rounded-3 px-4 w-100"
                                    ...
                                    <div class=" fs-20px">
                                        <a href="#" class="text-decoration-none d-block">
                                            <div class="text-green-2 fw-500 text-truncate">Telefone</div>
                                            <div class="text-green">(10) 98765-4321</div>
                                        </a>
                                    </div>
                            ...
                            <div class="mb-3">
                                <div class="d-flex align-items-center p-3 rounded-3 px-4 w-100"
                                    ...
                                    <div class=" fs-20px">
                                        <a href="#" class="text-decoration-none d-block">
                                            <div class="text-green-2 fw-500 text-truncate">Email</div>
                                            <div class="text-green">fabiovieira@email.com</div>
                                        </a>
                                    </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('farmacia')): ?>
        ...
        <!-- modal cliente -->
        <script>
            const myModal = new bootstrap.Modal(document.getElementById("modal-ver-cliente"), {});
...
<?php echo $__env->make('layouts.painel.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u292571460/domains/indutivatecnologia.com/public_html/dsf/resources/views/pages/painel/home.blade.php ENDPATH**/ ?>