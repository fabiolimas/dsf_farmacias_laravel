<?php $__env->startSection('title', 'Editar colaborador'); ?>
            ...
            <div class="col-12 col-lg-6 col-xl-4">
                <div class="card ">
                    <div class="card-body p-3 p-lg-4">
                        ...
                        <h1 class="fs-4 fw-600 mb-4 text-green-2 pt-2 pb-3">Editar colaborador</h1>

                        <form action="<?php echo e(route('painel.config.colaboradores.update', ['user' => $user->id])); ?>"
                            method="post">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-3 pb-2">
                                ...
                                <div class="d-flex gap-3 align-items-center">
                                    <label for="inputImage" id="label-img-perfil" class=" rounded-circle foto-perfil-config"
                                        style="background-image: url(<?php echo e(asset($user->img_perfil ?? 'assets/img/icons/upload-2.png')); ?>)">
...
<?php echo $__env->make('layouts.painel.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u292571460/domains/indutivatecnologia.com/public_html/dsf/resources/views/pages/painel/config/colaboradores/edit.blade.php ENDPATH**/ ?>