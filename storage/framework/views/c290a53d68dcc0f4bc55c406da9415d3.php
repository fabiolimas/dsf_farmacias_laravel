        ...
        <div class="row gy-4">
                    ...
                    <div class="card-body px-2 py-4">
                        ...
                        <div class=" px-4">
                            <a class="btn btn-primary d-block d-md-inline-block mb-3   "
                                href="<?php echo e(route('painel.usuarios.create')); ?>" role="button" style="padding: 16px 24px;">
                            ...
                            <a name="" id="" class="btn btn-outline-primary d-block d-md-inline-block mb-3 "
                                href="<?php echo e(route('painel.usuarios.list')); ?>" role="button" style="padding: 16px 24px;">
                                <div class="d-flex gap-2 align-items-center">
                        ...
                        <div class="mt-2 pt-1 ">
                            <div class="">
                                ...
                                <!-- lista -->
                                <div class="mt-4 pt-2">
                                    <div class="lista-scroll clientes-lista-usuarios px-4">
                                        <?php $__currentLoopData = [3, 33, 3]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="d-flex mb-3 pt-1 align-items-center">
                                                    ...
                                                    <div class="bg-white position-relative bg-logo-farmacia"
                                                        ...
                                                        <div class=""
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                                ...
                                                                <circle cx="14" cy="14" r="13" fill="#27CA40"
                                                ...
                                                <div class=" fs-20px ms-3">
                                                    <a href="#" class="text-decoration-none" data-bs-toggle="modal"
                                                        ...
                                                        <div class="text-green-2 fw-500">Drogasil 00.876.202/0001-00</div>
                                                        <div class="text-green">Cliente desde outubro de 2023</div>
                                                    </a>
                                                </div>

                                                <!-- opcoes -->
                                                <div class="ms-auto" data-bs-toggle="modal" data-bs-target="#modal-info">
                                            ...
                                            <div class="d-flex mb-3 pt-1 align-items-center">
                                                        ...
                                                        <div class=""
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                                ...
                                                                <circle cx="14" cy="14" r="13"
                                                                    fill="#FFC130" stroke="white" stroke-width="2" />
                                                            </svg>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class=" fs-20px ms-3">
                                                    <a href="#" class="text-decoration-none" data-bs-toggle="modal"
                                                        data-bs-target="#modal-info">
                                                        <div class="text-green-2 fw-500">PagueMenos 40.091.555/0001-00
                                                        </div>
                                                        <div class="text-green">Cliente desde outubro de 2023</div>
                                                    </a>
                                                </div>
                                                    ...
                                                    <div class="bg-white position-relative bg-logo-farmacia"
                                                        ...
                                                        <div class=""
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                                height="25" viewBox="0 0 28 28" fill="none">
                                                                <circle cx="14" cy="14" r="13"
                                                                    fill="#FF6058" stroke="white" stroke-width="2" />
                                                            </svg>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div class="col-12 col-lg-6 col-xl-4">
                <div class="card min-vh-100">
                    <div class="card-body px-2 py-4">
                        <div class="px-1">
                            <h2 class="fs-4 px-3 fw-600 mb-4 text-green-2 text-center">
                                Últimas assinaturas
                                <span class="badge rounded-pill text-bg-primary fs-16px fw-500 px-2">
                                    +4
                                </span>
                            </h2>
                            ...
                            <div class="position-relative">
                                ...
                                <div class="mt-2 lista-scroll p-3 clientes-lista-assinantes ">
                                    <?php $__currentLoopData = [3, 3, 3, 3, 3, 3, 3, 33, 3, 3, 33, 3, 3, 3]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div
                                            class="bg-green-light border-green-light rounded-3 d-flex gap-3 p-3 fw-500 text-green-2 align-items-center mb-3">
                                            <div class="">
                                                <img src="<?php echo e(asset('assets/img/ilustracoes/logo-fm-pg-menos.png')); ?>"
                                                    alt="" width="32" class="rounded-3">
                                            </div>
                                            <div class="fs-20px text-truncate">
                                                Droga Raia 69.226.883/0001-59
                                            </div>
...
<?php echo $__env->make('layouts.painel.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u292571460/domains/indutivatecnologia.com/public_html/dsf/resources/views/pages/painel/usuarios/index.blade.php ENDPATH**/ ?>