                                ...
                                <div class="d-flex flex-column mb-3 pt-1 align-items-center">
                                    ...
                                    <div class=" fs-24px ">
                                        <a href="#" class="text-decoration-none"
                                            ...
                                            <div class="mt-3 fs-16px">
                                                <a type="button"
                                                    onclick="setDataCliente('${res.data[i].id}')"
                                                    data-bs-target="#modal-info"
                                                    class="btn btn-primary-light w-100 py-2 fs-16px text-green">
                                                    Ver informações
                                                </a>
                                            </div>
                                        </a>
...
<?php echo $__env->make('layouts.painel.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u292571460/domains/indutivatecnologia.com/public_html/dsf/resources/views/pages/painel/admin/clientes/list.blade.php ENDPATH**/ ?>