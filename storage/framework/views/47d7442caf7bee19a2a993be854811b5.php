<?php $__env->startSection('title', 'Adicionar Cargo'); ?>
<?php $__env->startSection('content'); ?>
    <div class="">
        <form action="<?php echo e(route('painel.config.cargos.store')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <div class="row gy-4">
...
unset($__errorArgs, $__bag); ?>"
                                    name="titulo" id="titulo" value="<?php echo e(old('titulo')); ?>" placeholder="ex: Farmacêutico"
                                    required />
                                ...
                                <div class="ms-auto">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="permissoes[0]"
                                            ...
                                            <?php if(old('permissoes.0')): ?> checked <?php endif; ?>>
                                    </div>
                                </div>
                            </div>
                            <!--  -->
                                ...
                                <div class="ms-auto">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="permissoes[1]"
                                            ...
                                            <?php if(old('permissoes.1')): ?> checked <?php endif; ?>>
                                    </div>
                                </div>
                            </div>
                            <!--  -->
                                ...
                                <div class="ms-auto">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="permissoes[2]"
                                            ...
                                            <?php if(old('permissoes.2')): ?> checked <?php endif; ?>>
                                    </div>
                                </div>
                            </div>
                            <!--  -->
                                ...
                                <div class="ms-auto">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="permissoes[3]"
                                            ...
                                            <?php if(old('permissoes.3')): ?> checked <?php endif; ?>>
                                    </div>
                                </div>
                            </div>
                            <!--  -->
                                ...
                                <div class="ms-auto">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="permissoes[4]"
                                            value="ajustes" <?php if(old('permissoes.4')): ?> checked <?php endif; ?>
...
<?php echo $__env->make('layouts.painel.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u292571460/domains/indutivatecnologia.com/public_html/dsf/resources/views/pages/painel/config/cargos/create.blade.php ENDPATH**/ ?>