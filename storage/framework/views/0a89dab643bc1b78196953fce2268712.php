            ...
            <div class="col-12 col-lg-5 col-xl-4">
                <div class="card ">
                    <div class="card-body py-3 px-0 px-md-2 px-lg-2  py-lg-4">
                        ...
                        <form action="<?php echo e(route('painel.farmacia.agenda.update', $agenda->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="mb-0 position-relative">
                                        <label for="pesquisa" class="form-label text-green fw-500 fs-18px w-100">
                                            <div class="d-flex justify-content-between gap-2 w-100 align-items-center">
                                                Cliente
                                                <a href="<?php echo e(route('painel.farmacia.clientes.create')); ?>"
                                        ...
                                        <div class="position-relative">
                                                ...
                                                <select name="cliente_farmacia_id" id="cliente" class="form-select form-control-custom">
                                                    <option value="<?php echo e($clienteAgendado->id); ?>"><?php echo e($clienteAgendado->nome); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="<?php echo e($exameAgendado->id); ?>"><?php echo e($exameAgendado->nome); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3 pb-3">
                                    ...
                                    <input type="date"
                                        class="form-control form-control-custom fs-18px fw-500 <?php $__errorArgs = ['data_exame'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(date('Y-m-d', strtotime($agenda->data_exame))); ?>" />
                                    <?php $__errorArgs = ['data_exame'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(date('H:i', strtotime($agenda->hora_exame))); ?>" />
...
<?php echo $__env->make('layouts.painel.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\indutiva\dsf_farmacias_laravel\resources\views/pages/painel/farmacia/agenda/edit.blade.php ENDPATH**/ ?>