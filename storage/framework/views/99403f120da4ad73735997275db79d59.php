            ...
            <div class="col-12 col-lg-6 col-xl-4">
                <div class="card ">
                    <div class="card-body p-3 p-lg-4">
                        ...
                        <h1 class="fs-4 fw-600 mb-4 text-green-2 pt-2">Editar Usuário</h1>

                        <form action="<?php echo e(route('painel.admin.clientes.edit-usuario', $user->id)); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    name="password" id="password" placeholder="" value="<?php echo e(old('password')); ?>" />
            ...
            <div class="col-12 col-lg-6 col-xl-4">
                <div class="card">
                    <div class="card-body p-3 p-lg-4">
                        ...
                        <form action="<?php echo e(route('painel.admin.clientes.store-pagamento', ['user' => $user->id])); ?>"
                            method="post">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('numero_cartao', $user->cliente->numero_cartao)); ?>" required />
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('validade_cartao', $user->cliente->validade_cartao)); ?>"
                                    min="<?php echo e(date('Y-m')); ?>" required />
...
<?php echo $__env->make('layouts.painel.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u292571460/domains/indutivatecnologia.com/public_html/dsf/resources/views/pages/painel/admin/clientes/edit.blade.php ENDPATH**/ ?>